...
class Routers {
    useRoutes(app, coreHelper) {
        ...
        app.post("/api/chat/accept-contacts", 'api.chat.accept.contacts', [useAuthenticateApiToken.verifyToken, useMiddlewareAngular.isAuthenticated], chatController.postApiAcceptContact);
        // -----------------------------------E Angular 5-------------------------------------------
